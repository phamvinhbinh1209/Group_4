    ...
    <body>
        ...
        <div class="container-fluid mybody">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1>ADD NEW IMPORTSOURCE</h1>
                    <form method="post" action="AdminController">
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6">
                                    Input ID:
                                    <input type="number" required="" name="paraID" style="margin-left: 50px"><br>
                                    Product Name:
                                    <input type="text" required="" name="paraProductName" style="margin-left: 5px"><br>
                                    Brand:
                                    <input type="text" required="" name="paraBrand" style="margin-left: 66px"><br>
                                    Color:
                                    <input type="text" required="" name="paraColor" style="margin-left: 69px"><br>
                                </div>
                                <div class="col-md-6">
                                    Size:
                                    <input type="number" required="" name="paraSize" style="margin-left: 38px"><br>
                                    Quantity:
                                    <input type="number" required="" name="paraQuantity" style="margin-left: 5px"><br>
                                    Price:
                                    <input type="number" required="" name="paraPrice" style="margin-left: 32px"><br>
                                    Date Buy:
