                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-3" style="margin-top: 11px">
                                    <a href="/AdminController/AddNewImportSource" class="rounded-button" style="padding: 4px;">Add New</a>
                                </div>
                        ...
                        <table class="table" id="product-table">
                            ...
                            <tbody id="table-body">
                                ...
                                <tr>
                                    ...
                                    <td><%= rs.getDate("DateBuy")%></td>
                                    <td class="d-flex">
                                        <a onclick="return confirm('Are you sure to delete?')" href="/AdminController/DeleteImportSource/<%= rs.getInt("ID")%>">
                                            <i class="fa-solid fa-trash fa-xl mr-2 mt-2 xoaSapXep" alt="Xóa Sản Phẩm Đã Chọn"></i></a>
                                        <a href="/AdminController/UpdateImportSource/<%= rs.getInt("ID")%>">
