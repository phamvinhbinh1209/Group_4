                    ...
                    <div class="add-search-feature">
                        <div class="row add-search-control">
                            <div class="col-md-8 d-flex">
                                <a class="mb-1" style="border-radius: 10px; display: inline-block; padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none;" href="/Admin/AddNewProduct">Add New+</a>
                        ...
                        <table class="table" id="product-table">
                            ...
                            <tbody id="table-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="height: 80px; width: 90px" src="<%= rs.getString("Image")%>" alt="Product Image">
                                    </td>
                                    ...
                                    <td class="d-flex">                                 
                                        <a onclick="return confirm('Are you sure Delete Product?')" class="fa-solid fa-trash fa-xl mr-2 mt-2 " href="/Admin/DeleteProduct/<%= rs.getInt("ProductID")%>" style="color: black;"></a>
                                        <a class="fa-solid fa-pen-to-square fa-xl mt-2" href="/Admin/UpdateProduct/<%= rs.getInt("ProductID")%>" style="color: black;"></a>
                                    </td>
                                </tr>
