                        ...
                        <form method="post" action="AdminController">
                            <fieldset>
                                <div class="row inputblock">
                                    <div class="col-md-6">
                                        Image:
                                        <input class="inputinf" type="text" required="" name="paraImage" style="margin-left: 68px;"><br>
                                        Product Name:
                                        <input class="inputinf" type="text" required="" name="paraProductName" style="margin-left: 10px; margin-top: 10px;"><br>
                                    </div>
                                    <div class="col-md-6">
                                        Price:
                                        <input class="inputinf" type="number" required="" name="paraPrice" style="margin-left: 50px;"><br>
                                        Description:
                                        <input class="inputinf" type="text" required="" name="paraDescription" style="margin-left: 5px; margin-top: 10px;"><br>
                                        <div class="submitinf" style="margin-left: 155px; margin-top: 10px;">
                                            <input type="reset" value="Clear" name="btnSubmitAdd">
                                            <input type="submit" value="Confirm" name="btnSubmitAddProduct">
                                        </div>
                                    </div>
