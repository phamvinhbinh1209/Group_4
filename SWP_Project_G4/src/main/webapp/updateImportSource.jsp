                    ...
                    <form method="post" action="AdminController">
                        <fieldset>
                            <div class="row">
                                <div class="col-md-6">
                                    Input ID:
                                    <input type="number" required="" name="paraID" readonly="true" style="margin-left: 50px" value="<%= ip.getID()%>"><br>
                                    Product Name:
                                    <input type="text" required="" name="paraProductName" style="margin-left: 5px" value="<%= ip.getProductName()%>"><br>
                                    Brand:
                                    <input type="text" required="" name="paraBrand" style="margin-left: 66px" value="<%= ip.getBrand()%>"><br>
                                    Color:
                                    <input type="text" required="" name="paraColor" style="margin-left: 69px" value="<%= ip.getColor()%>"><br>
                                </div>
                                <div class="col-md-6">
                                    Size:
                                    <input type="number" required="" name="paraSize" style="margin-left: 38px" value="<%= ip.getSize()%>"><br>
                                    Quantity:
                                    <input type="number" required="" name="paraQuantity" style="margin-left: 5px" value="<%= ip.getQuantity()%>"><br>
                                    Price:
                                    <input type="number" required="" name="paraPrice" style="margin-left: 32px" value="<%= ip.getPrice()%>"><br>
                                    Date Buy:
                                    <input type="date" required="" name="paraDateBuy" style="margin-left: 3px"><br>
                                </div>
