                        ...
                        <form method="post" action="AdminController">
                            <fieldset>
                                <div class="row inputblock">
                                    <div class="col-md-6">
                                        Size ID:
                                        <input class="inputinf" type="number" required="" name="paraSizeID" readonly="true" style="margin-left: 50px" value="<%= ip.getSizeID()%>"><br>
                                        Number Of Size:
                                        <input class="inputinf" type="number" required="" name="paraNumSize" readonly="true" style="margin-left: 38px" value="<%= ip.getNumSize()%>"><br>
                                    </div>
                                    <div class="col-md-6">
                                        Product ID:
                                        <input class="inputinf" type="number" required="" name="paraProductID" readonly="true" style="margin-left: 5px" value="<%= ip.getProductID()%>"><br>
                                        Quantity:
                                        <input class="inputinf" type="number" required="" name="paraQuantity" style="margin-left: 5px" value="<%= ip.getQuantity()%>"><br>
